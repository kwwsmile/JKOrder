 ...
 */
public class SearchSysParamAdapter extends ArrayAdapter<selectshopBean.DataBean.ListBean> {

    private Context mContext;
    private List<selectshopBean.DataBean.ListBean> mListData;
     ...
     * @param type
     */
    public SearchSysParamAdapter(Context context, List<selectshopBean.DataBean.ListBean> listData, int sId, int nId, int type) {
