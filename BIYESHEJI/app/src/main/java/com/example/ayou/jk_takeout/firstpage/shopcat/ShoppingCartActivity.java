...
import com.example.ayou.jk_takeout.firstpage.view.CheckOutActivity;
...
public class ShoppingCartActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id = intent.getStringExtra("cartID");
        lowPrice = intent.getIntExtra("lowPrice",0);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tvSubmit:
                ...
                //// TODO: 2017/6/6 传递菜名
                SelectFoodEvent event = new SelectFoodEvent(EventConfig.SELECT_FOOD);
