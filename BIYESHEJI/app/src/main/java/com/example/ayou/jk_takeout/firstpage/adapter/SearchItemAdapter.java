 ...
 */
public class SearchItemAdapter extends ArrayAdapter<selectshopBean.DataBean.ListBean.SublogsBean> {

    private Context mContext;
    private List<selectshopBean.DataBean.ListBean.SublogsBean> mListData;
     ...
     * @param type
     */
    public SearchItemAdapter(Context context, List<selectshopBean.DataBean.ListBean.SublogsBean> listData, int sId, int nId, int type) {
